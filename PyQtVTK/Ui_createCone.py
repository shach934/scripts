...
class Ui_createCone(object):
    def setupUi(self, createCone):
        ...
        self.coneDirectZInput = QtWidgets.QLineEdit(createCone)
        self.coneDirectZInput.setObjectName("coneDirectZInput")
        self.horizontalLayout_2.addWidget(self.coneDirectZInput)
    ...
    def retranslateUi(self, createCone):
        ...
        self.coneDirectZInput.setText(_translate("createCone", "1"))
