...
# Form implementation generated from reading ui file 'C:/Shaohui/OpenFoam/scripts/PyQtVTK/Ui_Files/Ui_fvSolution_PBiCG.ui'
#
...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.groupBox_2.setTitle(_translate("Form", "PBiCG Configuration"))
        self.label.setText(_translate("Form", "Preconditioner"))
        self.comboBox.setItemText(0, _translate("Form", "DILU"))
        self.comboBox.setItemText(1, _translate("Form", "Diagonal"))
