...
openDir_button = tk.Button(root, text = 'Open Directory', width = button_size[0], height = button_size[1]) #, command = lambda event: open_path(event, path))
...
solver_Combo = make_Combo(solver_tab, "application: ", label_size, solver_tab_grid, solver_pool, combo_size, label_justify, combo_opt)
...
writeInterval_entry = make_entry(solver_tab, "writeInterval: ", label_size, solver_tab_grid, entry_width, label_justify, entry_opt)
...
adjustTimeStep_Combo = make_Combo(solver_tab, "adjustTimeStep: ", label_size, solver_tab_grid, switch_pool, combo_size, label_justify, adjustTimeStep_opt)
...
div_pool = ["Gauss upwind", "bounded Gauss upwind", "Gauss limitedLinear 1", "bounded Gauss linearUpwind limited", "bounded Gauss limitedLinear 1",  "Gauss linear"]

div_phi_k = tk.StringVar()
div_phi_k_opt = {"justify":"left", "textvariable":div_phi_k}
div_phi_k_Combo = make_Combo(fluid_group, "div_phi_k: ", label_size, fvSchemes_tab_grid, div_pool, combo_size, label_justify, div_phi_k_opt)
...
div_phi_epsilon_Combo = make_Combo(fluid_group, "div_phi_epsilon: ", label_size, fvSchemes_tab_grid, div_pool, combo_size, label_justify, div_phi_epsilon_opt)
div_phi_epsilon.set(div_phi_epsilon_Combo.get())

div_phi_h = tk.StringVar()
div_phi_h_opt = {"justify":"left", "textvariable":div_phi_h}
div_phi_h_Combo = make_Combo(fluid_group, "div_phi_h: ", label_size, fvSchemes_tab_grid, div_pool, combo_size, label_justify, div_phi_h_opt)
...
div_phi_nuTilda_Combo = make_Combo(fluid_group, "div_phi_nuTilda: ", label_size, fvSchemes_tab_grid, div_pool, combo_size, label_justify, div_phi_nuTilda_opt)
...
div_Ji_Ii_h_Combo = make_Combo(fluid_group, "div_Ji_Ii_h: ", label_size, fvSchemes_tab_grid, div_pool, combo_size, label_justify, div_Ji_Ii_h_opt)
...
divrho_nuEff_dev2TgradU_Combo = make_Combo(fluid_group, "divrho_nuEff_dev2TgradU: ", label_size, fvSchemes_tab_grid, div_pool, combo_size, label_justify, divrho_nuEff_dev2TgradU_opt)
